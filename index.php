...
function dbconect(){
	$db = new PDO('mysql:host=localhost;dbname=weiphp', 'root', '123456');
	return $db;
...
move_uploaded_file($_FILES["file"]["tmp_name"],"upload/".$filename.".jpg");

$result = "upload/".$filename.".jpg";
print_r($result);exit;
...
$_SESSION["aa"] = "我是第1个SESSION值";
$_SESSION["bb"] = "我是第2个SESSION值";
$_SESSION["cc"] = "我是第3个SESSION值";
$_SESSION["dd"] = "我是第4个SESSION值";
$_SESSION["ff"] = "我是第5个SESSION值";
print_r($_SESSION); */

$array['buyer_name'] = "69ndj3c77mjnq5t6s6l6mcbnu6";
$array['telephone'] = "1370594xxx2";
$array['min_price'] = "10.23";
$array['max_price'] = "1000.89";
$array['car_age'] = "5";
$array['gearbox_type'] = "Yes";
$array['note'] = "无";
$array1['series'][] = "61:1997";
$array1['series'][] = "62:1998";
$array1['series'][] = "63:1999";

echo json_encode($array);exit;

echo $_GET['username']."<br>";
$strJson = $_GET['param'];
// $strJson = '{["61:1997","62:1998","63:1999"]}';
print_r(json_decode($strJson,true));exit;
// $strJson = '{"buyer_name":"\u5f20\u4e09","telephone":"1370594xxx2","min_price":"10.23","max_price":"1000.89","car_age":"5","gearbox_type":"Yes","note":"\u65e0","series":["61:1997","62:1998","63:1999"]}';

// $s = file_get_contents("http://f10.bestgo.com/sx/2016-01-05-fund.txt");
$s = file("http://f10.bestgo.com/sx/2016-01-05-fund.txt");
/*print_r($s[0]);
$d = explode("	", $s[0]);
print_r($d);*/
...
foreach ($s as $v) {
	...
	$sql .= "INSERT INTO mtwxweixin_dxgp_code (gp_code,gp_code_reply,add_time) VALUES('{$d[1]}','资金流进流出：{$d[2]}','$nowtime');<br> ";
